...
/* 内部宏定义 ----------------------------------------------------------------*/
#define PW_huart   huart1           //pid无线调参使用串口
...
void PID_Params_Set(MsgsFrame_struct *pidSet)
{
    ...
    PID[index].pid_mode = pidSet->PID.PID_Mode;
    PID[index].Kp = pidSet->PID.Kp_value.tempFloat;
    PID[index].Ki = pidSet->PID.Ki_value.tempFloat;
    PID[index].Kd = pidSet->PID.Kd_value.tempFloat;
    
    PID[index].max_pout = pidSet->PID.P_out_max.tempFloat;
    PID[index].max_iout = pidSet->PID.I_out_max.tempFloat;
    PID[index].max_dout = pidSet->PID.D_out_max.tempFloat;
//    motor_pid[index].pidout_max = pidSet->PID.PID_out_max.tempFloat;
    
    PID[index].max_out = pidSet->PID.PID_out_max.tempFloat;
}
...
void PID_Params_Upload(char motor_ID)
{
    ...
    tempMsgs.PID.PID_Mode = PID[motor_ID].pid_mode;
    tempMsgs.PID.Kp_value.tempFloat  = PID[motor_ID].Kp;
    tempMsgs.PID.Ki_value.tempFloat  = PID[motor_ID].Ki;
    tempMsgs.PID.Kd_value.tempFloat  = PID[motor_ID].Kd;
    tempMsgs.PID.P_out_max.tempFloat = PID[motor_ID].max_pout;//TODO
    tempMsgs.PID.I_out_max.tempFloat = PID[motor_ID].max_iout;//TODO
    tempMsgs.PID.D_out_max.tempFloat = PID[motor_ID].max_dout;//TODO
//    tempMsgs.PID.PID_out_max.tempFloat = motor_pid[motor_ID].pidout_max;
    tempMsgs.PID.PID_out_max.tempFloat = PID[motor_ID].max_out;
